...
type Batch struct {
	...
	BatchRecved  time.Time `protobuf:"bytes,6,opt,name=batch_recved,json=batchRecved,proto3,stdtime" json:"batch_recved"`
}
...
func (m *Batch) GetBatchOwner() string {
	if m != nil {
		return m.BatchOwner
	}
	return ""
...
func (m *Batch) GetBatchSize() int64 {
	if m != nil {
		return m.BatchSize
	}
	return 0
...
func (m *Batch) GetBatchCreated() time.Time {
	if m != nil {
...
func (m *Batch) GetBatchRecved() time.Time {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Batch)(nil), "tendermint.types.Batch")
}
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *Batch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n21, err21 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.BatchRecved, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.BatchRecved):])
	if err21 != nil {
		return 0, err21
	}
	i -= n21
	...
	i--
	dAtA[i] = 0x32
	n22, err22 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.BatchCreated, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.BatchCreated):])
	if err22 != nil {
		return 0, err22
	}
	i -= n22
	...
	dAtA[i] = 0x2a
	if m.BatchSize != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.BatchSize))
		i--
		dAtA[i] = 0x20
	}
...
func (m *Batch) Size() (n int) {
	...
	if m.BatchSize != 0 {
		n += 1 + sovTypes(uint64(m.BatchSize))
	}
