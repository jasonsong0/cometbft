...
//NOTE: each mempool has a own abci client to communicate with the application
...
type CListMempool struct {
	...
	// notify listeners (ie. batch maker) when txs are available
	...
	//TODO(jason): check if FLUSH is ok for multiple worker
